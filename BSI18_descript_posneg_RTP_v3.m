...
%pos_locrtp   = T4S.time_t_RTP(( T4S.sex == 1 | T4S.sex == 2) & T4S.LOC == 1);
%neg_locrtp   = T4S.time_t_RTP(( T4S.sex == 1 | T4S.sex == 2) & T4S.LOC == 0);
...
%pos_bsirtp = T4S.time_t_RTP(b_total >= BSI18_max);
%neg_bsirtp = T4S.time_t_RTP(b_total < BSI18_max );
...
% xlabel('Return to Play');
 %ylabel('Number of Athletes');


%Effect sizes
d3 = computeCohen_d( [pos_mhhxrtp'], ...
   [neg_mhhxrtp'], 'independent');

%Hypothesis testing
[H,P3,KSSTAT] = kstest2([pos_mhhxrtp'],[neg_mhhxrtp']);
text(20,.15,['d='  num2str(d3,'%3.2f') '  ' '\itp\rm=',num2str(P3,'%4.3f')] );
...
% New ANOVA TABLE
[p,tbl,stats]=kruskalwallis( [pos_ladhxstimrtp;pos_ladhxnostimrtp;neg_ladhxrtp], predictors, 'off' )
...
% %Effect sizes
% d3 = computeCohen_d( [pos_ladhxrtp'], ...
%    [neg_ladhxrtp'], 'independent');
% 
% %Hypothesis testing
% [H,P3,KSSTAT] = kstest2([pos_ladhxrtp'],[neg_ladhxrtp']);
% text(26,.15,['d=' num2str(d3,'%3.2f') '  ' 'p=',num2str(P3,'%4.3f')] );

% % Cox proportional hazzard
% predictors=categorical([ones(length(pos_ladhxrtp),1);ones(length(neg_ladhxrtp),1)+1]);
% data = table(predictors,[pos_ladhxrtp;neg_ladhxrtp],'VariableNames',["Predictors" "RTP"]);
% mdl = fitcox(data,"RTP");
% text(20,0.075,['\beta = ' num2str(mdl.Coefficients{1,1},'%3.3f') ' \itp\rm = ' num2str(mdl.Coefficients{1,4},'%3.2f') ])
...
ha = axes;
nlp_axes_prep(ha);
set(gca,'Position',[5.25 8.5 2 2] ); % gca = graphical current axes % left bottom width height
set(gca,'FontSize', 12          );
set(gca,'xlim',    XL           );
set(gca,'ylim',    [0 1.05]     );
set(gca,'XTick',   XT           );
...
%Effect sizes
d3 = computeCohen_d( [pos_conhxrtp'], ...
   [neg_conhxrtp'], 'independent');

%Hypothesis testing
[H,P3,KSSTAT] = kstest2([pos_conhxrtp'],[neg_conhxrtp']);
text(23,.15,['d=' num2str(d3,'%3.2f') ' p=' num2str(P3,'%4.3f') ] );
...
ha = axes;
nlp_axes_prep(ha);
set(gca,'Position',[.75 5.85 2 2]   ); % gca = graphical current axes % left bottom width height
set(gca,'FontSize', 12           );
set(gca,'xlim',    XL            );
set(gca,'ylim',    [0 1.05]      );
set(gca,'XTick',   XT            );
...
%Effect sizes
d3 = computeCohen_d( [pos_mighxrtp'], ...
   [neg_mighxrtp'], 'independent');

%Hypothesis testing
[H,P3,KSSTAT] = kstest2([pos_mighxrtp'],[neg_mighxrtp']);
text(20,.15,['d='  num2str(d3,'%3.2f') '  ' 'p=',num2str(P3,'%4.3f')] );
...
%Effect sizes
d3 = computeCohen_d( [pos_locrtp'], ...
   [neg_locrtp'], 'independent');

%Hypothesis testing
[H,P3,KSSTAT] = kstest2([pos_locrtp'],[neg_locrtp']);
text(26,.15,['d=' num2str(d3,'%3.2f') '  ' 'p=',num2str(P3,'%4.3f')] );
...
ha = axes;
nlp_axes_prep(ha);
set(gca,'Position',[5.25 5.85 2 2] ); % gca = graphical current axes % left bottom width height
set(gca,'FontSize', 12          );
set(gca,'xlim',    XL           );
set(gca,'ylim',    [0 1.05]     );
set(gca,'XTick',   XT           );
...
%Effect sizes
d3 = computeCohen_d( [femalertp'], ...
   [malertp'], 'independent');

%Hypothesis testing
[H,P3,KSSTAT] = kstest2([femalertp'],[malertp']);
text(23,.15,['d=' num2str(d3,'%3.2f') ' p=' num2str(P3,'%4.3f') ] );
...
ha = axes;
nlp_axes_prep(ha);
set(gca,'Position',[.75 3.25 2 2] ); % gca = graphical current axes % left bottom width height
set(gca,'FontSize', 12          );
set(gca,'xlim',    XL           );
set(gca,'ylim',    [0 1.05]     );
set(gca,'XTick',   XT           );
...
%[x5, y5] = cumsum_dist(cadetrtp   );

plot(x1,y1, 'Color',ORANGE, 'LineStyle','-', 'LineWidth',2 );
plot(x2,y2, 'Color',CYAN,   'LineStyle','-', 'LineWidth',2 );
plot(x3,y3 ,'Color',MAGENTA,'LineStyle','-', 'LineWidth',2 );
plot(x4,y4, 'Color',GREEN,  'LineStyle','-', 'LineWidth',2 );
%plot(x5,y5, 'Color',BLACK,  'LineStyle','-', 'LineWidth',2 );
...
%text(75,.605,  ['CADET n='       num2str(length(cadetrtp   )) ],'FontSize',10,'Color',BLACK          );
...
% New ANOVA TABLE
[p,tbl,stats]=kruskalwallis( [nonconrtp;limconrtp;contactrtp;nonncaartp], predictors, 'off' )
% LARUEN ADD TABLE HERE
%
%data = table(predictors,[nonconrtp;limconrtp;contactrtp;nonncaartp],'VariableNames',["Predictors" "RTP"]);
%mdl = kruskalwallis(data, "RTP");
...
ha = axes;
nlp_axes_prep(ha);
set(gca,'Position',[3 3.25 2 2]   ); % gca = graphical current axes % left bottom width height
set(gca,'FontSize', 12           );
set(gca,'xlim',    XL            );
set(gca,'ylim',    [0 1.05]      );
set(gca,'XTick',   XT            );
...
%Effect sizes
d3 = computeCohen_d( [pos_scatrtp'], ...
   [neg_scatrtp'], 'independent');

%Hypothesis testing
[H,P3,KSSTAT] = kstest2([pos_scatrtp'],[neg_scatrtp']);
text(20,.15,['d='  num2str(d3,'%3.2f') '  ' '\itp\rm=',num2str(P3,'%4.3f')] );
...
ha = axes
nlp_axes_prep(ha)
set(gca,'Position',  [5.25 3.25 2 2]   );
set(gca,'FontSize',  12            );
set(gca,'xlim',      XL            );
set(gca,'ylim',      [0 1.05]      );
set(gca,'XTick',     XT            );
...
%Effect sizes
d3 = computeCohen_d( [pos_bsirtp'], ...
   [neg_bsirtp'], 'independent');

%Hypothesis testing
[H,P3,KSSTAT] = kstest2([pos_bsirtp'],[neg_bsirtp']);
text(26,.15,['d=' num2str(d3,'%3.2f') '  ' 'p=',num2str(P3,'%4.3f')] );
...
ha = axes;
nlp_axes_prep(ha);
set(gca,'Position',[.75 .6 2 2]   ); % gca = graphical current axes % left bottom width height
set(gca,'FontSize', 12           );
set(gca,'xlim',    XL            );
set(gca,'ylim',    [0 1.05]      );
set(gca,'XTick',   XT            );
...
%Effect sizes
d3 = computeCohen_d( [pos_delayrtp'], ...
   [neg_delayrtp'], 'independent');
...
text(200,-.1,'Wilkins et al, Fig 4')
...
set(gca,'ytick',[1:9],'yticklabel',names,'TickLabelInterpreter','None','FontSize',12);
...
axis equal
text(0.20, 0.90,['AUC = ' num2str(AUC,'%3.2f')],'FontSize',14 )
...
text( 1.2, -0.15,'Wilkins et al  Fig. 5','FontSize',12)
