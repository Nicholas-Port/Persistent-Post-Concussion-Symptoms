...
% for i = 1:size(T4S,1)
%     if T4S.time_t_RTP(i) < PCS & situation(i) == 3
%         noyes15 = noyes15 +1;
%     elseif T4S.time_t_RTP(i) >= PCS & situation(i) == 3
%         yesyes15 = yesyes15+1;
%     elseif T4S.time_t_RTP(i) < PCS & situation(i) ~= 3
%         nono15 = nono15 +1;
%     elseif T4S.time_t_RTP(i) >= PCS & situation(i) ~= 3
...
% for i = 1:size(T4S,1)
%     if T4S.time_t_RTP(i) < PCS & (ldhx(i) >= 1 & stimulant(i) == 1)
%         noyes17 = noyes17 +1;
%     elseif T4S.time_t_RTP(i) >= PCS & (ldhx(i) >= 1 & stimulant(i) == 1)
%         yesyes17 = yesyes17+1;
%     elseif T4S.time_t_RTP(i) < PCS & ldhx(i) == 0
%         nono17 = nono17 +1;
%     elseif T4S.time_t_RTP(i) >= PCS & ldhx(i) == 0
...
% for i = 1:size(T4S,1)
%     if T4S.time_t_RTP(i) < PCS & (ldhx(i) >= 1 & stimulant(i) == 0)
%         noyes18 = noyes18 +1;
%     elseif T4S.time_t_RTP(i) >= PCS & (ldhx(i) >= 1 & stimulant(i) == 0)
%         yesyes18 = yesyes18+1;
%     elseif T4S.time_t_RTP(i) < PCS & ldhx(i) == 0
%         nono18 = nono18 +1;
%     elseif T4S.time_t_RTP(i) >= PCS & ldhx(i) == 0
...
text(1.5,3.5,'BSI Total Score >30');
ht=text(.5,1.5,['Return to Play > ' num2str(PCS) ],'Rotation',90);
...
text(1.5,3.5,'SCAT Total Score >68');
ht=text(.5,1.5,['Return to Play > ' num2str(PCS)],'Rotation',90);
...
text(0,1,['Odds Ratio = $\frac{' num2str(yesyes18) '/'  num2str(yesno18) '}{' ...
...
OR_l = OR_Logistic1(y_nostim, x_nostim);
text(2,0,['OR_L = ' num2str(OR_l,'%4.3f' )],'FontSize',12,'Interpreter','none'  );
