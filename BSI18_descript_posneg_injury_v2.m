...
text(1,.075,['Cohen''s \itd\rm='  num2str(d3,'%3.2f') ' ' ' \itp\rm = ',num2str(P3,'%4.3f')] );
...
text(3,.075,['\itd\rm='  num2str(d3,'%3.2f') '  ' ' \itp\rm = ',num2str(P3,'%4.3f')] );
...
text(20,.075,['\itd\rm='  num2str(d3,'%3.2f') '  ' ' \itp\rm = ',num2str(P3,'%4.3f')] );
...
text(6,.075,['\itd\rm='  num2str(d3,'%3.2f') '  ' ' \itp\rm = ',num2str(P3,'%4.3f')] );
...
text(18,.075,['\itd\rm='  num2str(d3,'%3.2f') '  ' ' \itp\rm = ',num2str(P3,'%4.3f')] );


text(180,-.1,'Rooks et al, Suppl. Fig. 2')
